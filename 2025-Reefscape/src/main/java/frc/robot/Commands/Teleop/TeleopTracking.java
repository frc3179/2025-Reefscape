...
public class TeleopTracking extends Command {
    ...
    public void execute() {
        ...
        if(!doRejectUpdate1)
        {
            TrackingSubsystem.poseEstimator.setVisionMeasurementStdDevs(limelight1VisionMeasurementStdDevs);
        ...
        if(!doRejectUpdate2)
        {
            TrackingSubsystem.poseEstimator.setVisionMeasurementStdDevs(limelight2VisionMeasurementStdDevs);
            TrackingSubsystem.poseEstimator.addVisionMeasurement(
                limelight1.pose,
                limelight1.timestampSeconds
            );
        ...
        if(!doRejectUpdate3)
        {
            TrackingSubsystem.poseEstimator.setVisionMeasurementStdDevs(limelight3VisionMeasurementStdDevs);
            TrackingSubsystem.poseEstimator.addVisionMeasurement(
                limelight1.pose,
                limelight1.timestampSeconds
            );
